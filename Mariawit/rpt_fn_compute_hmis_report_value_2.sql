...
-- None
ELSIF p_indic_name = 'indic_FP_IPPF_Mtd_5' THEN IF p_record_x.ppfp = 'yes' AND 
...
(p_record_x.anc1_date IS NOT NULL AND p_record_x.anc1_date <> '' 
OR p_record_x.anc2_date IS NOT NULL AND p_record_x.anc2_date <> ''
OR p_record_x.anc3_date IS NOT NULL AND p_record_x.anc3_date <> ''
OR p_record_x.anc4_date IS NOT NULL AND p_record_x.anc4_date <> '')
...
AND p_record_x.monthly_report = 'yes' AND ABS(
  (p_record_x.fp_method_start_date::DATE - p_record_x.fp_prev_method_switch_date::DATE) / 30
) <= 6
