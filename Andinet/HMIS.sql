...
HEPHC_MODEL_H_1_1_ := 0;

HEPHC_MODEL_H_1_2_ := 0;

HEPHC_MODEL_H_1_3_ := 0;
...
ELSIF p_indic_name = 'indic_Number_of_slides_or_RDT_positive_for_malaria' THEN IF p_record_x.hew_rdt_result = 'positive' 
THEN Number_of_slides_or_RDT_positive_for_malaria := 1;
END IF;
...
AND p_record_x.anc1_date <> ''
AND p_record_x.anc1_gestational_age < 16
THEN pregnant_women_received_ANC_First_visit_by_gw_less_than_16 := 1;
END IF;
...
AND p_record_x.anc1_date <> ''
AND ABS((p_record_x.anc1_date::DATE - p_record_x.dob::DATE) / 365.25) Between 10 and  14
THEN ANC_1stV_MA_1_1 := 1;
END IF;
...
AND p_record_x.anc1_date <> ''
AND  ABS((p_record_x.anc1_date::DATE - p_record_x.dob::DATE) / 365.25) Between 15 and  19
THEN ANC_1stV_MA_1_2 := 1;
END IF;
...
AND p_record_x.anc1_date <> ''
AND ABS((p_record_x.anc1_date::DATE - p_record_x.dob::DATE) / 365.25) >= 20
THEN ANC_1stV_MA_1_3 := 1;
END IF;
...
ELSIF p_indic_name = 'indic_number_of_children_under_one_yr_received_bcg' THEN IF EXTRACT(
  MONTH
FROM AGE(p_record_x.bcg_date:: DATE, p_record_x.dob:: DATE)
...
ELSIF p_indic_name = 'indic_fp_new_at_10_to_14' THEN IF ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 10 and  14
AND p_record_x.yearly_report = 'yes'
AND p_record_x.fp_acceptor_type = 'new'
THEN fp_new_at_10_to_14 := 1;
END IF;
-- FP_CAR_Age.1.2:Family Planning:15-19 yr
ELSIF p_indic_name = 'indic_fp_new_at_15_to_19' THEN IF  ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 15 and  19
AND p_record_x.yearly_report = 'yes'
AND p_record_x.fp_acceptor_type = 'new'
THEN fp_new_at_15_to_19 := 1;
END IF;
-- FP_CAR_Age.1.3:Family Planning:20 - 24 yr
ELSIF p_indic_name = 'indic_fp_new_at_20_to_24' THEN IF  ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 20 and  24
AND p_record_x.yearly_report = 'yes'
AND p_record_x.fp_acceptor_type = 'new'
THEN fp_new_at_20_to_24 := 1;
END IF;
-- FP_CAR_Age.1.4:Family Planning:25 -29 yr
ELSIF p_indic_name = 'indic_fp_new_at_25_to_29' THEN IF  ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 25 and  29
AND p_record_x.yearly_report = 'yes'
AND p_record_x.fp_acceptor_type = 'new'
THEN fp_new_at_25_to_29 := 1;
END IF;
-- FP_CAR_Age.1.5:Family Planning:30 -49 yr
ELSIF p_indic_name = 'indic_fp_new_at_30_to_49' THEN IF ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 30 and  49
AND p_record_x.yearly_report = 'yes'
AND p_record_x.fp_acceptor_type = 'new'
THEN fp_new_at_30_to_49 := 1;
END IF;
-- FP_CAR_Age.2.1:Family Planning:10-14 yr
ELSIF p_indic_name = 'indic_fp_repeat_at_10_to_14' THEN IF  ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 10 and 14
AND p_record_x.yearly_report = 'yes'
AND p_record_x.fp_acceptor_type = 'repeat'
THEN fp_repeat_at_10_to_14 := 1;
END IF;
-- FP_CAR_Age.2.2:Family Planning:15-19 yr
ELSIF p_indic_name = 'indic_fp_repeat_at_15_to_19' THEN IF   ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 15 and  19
AND p_record_x.yearly_report = 'yes'
AND p_record_x.fp_acceptor_type = 'repeat'
THEN fp_repeat_at_15_to_19 := 1;
END IF;
-- FP_CAR_Age.2.3:Family Planning:20 - 24 yr
ELSIF p_indic_name = 'indic_fp_repeat_at_20_to_24' THEN IF   ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 20 and  24
AND p_record_x.yearly_report = 'yes'
AND p_record_x.fp_acceptor_type = 'repeat'
THEN fp_repeat_at_20_to_24 := 1;
END IF;
-- FP_CAR_Age.2.4:Family Planning:25 -29 yr
ELSIF p_indic_name = 'indic_fp_repeat_at_25_to_29' THEN IF  ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 25 and  29
AND p_record_x.yearly_report = 'yes'
AND p_record_x.fp_acceptor_type = 'repeat'
THEN fp_repeat_at_25_to_29 := 1;
END IF;
-- FP_CAR_Age.2.5:Family Planning:30 -49 yr
ELSIF p_indic_name = 'indic_fp_repeat_at_30_to_49' THEN IF  ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 30 and  49
AND p_record_x.yearly_report = 'yes'
AND p_record_x.fp_acceptor_type = 'repeat'
THEN fp_repeat_at_30_to_49 := 1;
END IF;
...
ELSIF p_indic_name = 'indic_fp_at_10_to_14' THEN IF ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 10 and  14
AND p_record_x.ppfp = 'yes'
THEN fp_at_10_to_14 := 1;
END IF;
-- FP_IPPF_Age.2:Family Planning:15-19 yr
ELSIF p_indic_name = 'indic_fp_at_15_to_19' THEN IF  ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 15 and 19
AND p_record_x.ppfp = 'yes'
THEN fp_at_15_to_19 := 1;
END IF;
-- FP_IPPF_Age.3:Family Planning:20 - 24 yr
ELSIF p_indic_name = 'indic_fp_at_20_to_24' THEN IF  ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
) Between 20 and  24
AND p_record_x.ppfp = 'yes'
THEN fp_at_20_to_24 := 1;
END IF;
-- FP_IPPF_Age.4:Family Planning:25 -29 yr
ELSIF p_indic_name = 'indic_fp_at_25_to_29' THEN IF ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
)  Between 10 and 14
AND p_record_x.ppfp = 'yes'
THEN fp_at_25_to_29 := 1;
END IF;
-- FP_IPPF_Age.5:Family Planning:30-49 yr
ELSIF p_indic_name = 'indic_fp_at_30_to_49' THEN IF  ABS(
  (p_record_x.fp_report_date::DATE - p_record_x.dob::DATE) / 365.25
)  Between 30 and 49
AND p_record_x.ppfp = 'yes'
THEN fp_at_30_to_49 := 1;
END IF;
...
END IF;
-- still_births:Still birth rate - Number of still births
ELSIF p_indic_name = 'indic_still_births' THEN IF (p_record_x.outcome_location = 'health_post'
OR p_record_x.outcome_location = 'en_route_hp'
OR p_record_x.outcome_location = 'community')
THEN still_births := COALESCE((p_record_x.num_still_birth):: INTEGER, 0);
END IF;
-- still_live:Still birth rate - Number of Live births
ELSIF p_indic_name = 'indic_still_live' THEN IF (p_record_x.outcome_location = 'health_post'
OR p_record_x.outcome_location = 'en_route_hp'
OR p_record_x.outcome_location = 'community')
THEN still_live := COALESCE((p_record_x.num_live_birth):: INTEGER, 0);
END IF;
...
IF p_record_x.fp_acceptor_type = 'repeat'
AND (p_record_x.fp_method != 'oral_contraceptives'
OR p_record_x.fp_method != 'implants'
OR p_record_x.fp_method != 'injections'
OR p_record_x.fp_method != 'iucd')

THEN FP_CAR_Mtd_2_7 := 1;
END IF;
-- None
ELSIF p_indic_name = 'indic_FP_IPPF_Mtd_5' THEN IF p_record_x.ppfp = 'yes'
AND 
(p_record_x.fp_method != 'oral_contraceptives'
OR p_record_x.fp_method != 'implants'
OR p_record_x.fp_method != 'injections'
OR p_record_x.fp_method != 'iucd') THEN FP_IPPF_Mtd_5 := 1; 
END IF;
...
ELSIF p_indic_name = 'indic_number_of_under_5__pnemonia' THEN IF EXTRACT(
  MONTH
FROM AGE(
      p_record_x.illness_start_date:: DATE, p_record_x.dob:: DATE
    )
) <= 60
...
ELSIF p_indic_name = 'indic_ANC_4thV_MA_1_1' THEN IF 
(p_record_x.anc1_date IS NOT NULL
AND p_record_x.anc1_date <> ''
OR p_record_x.anc2_date IS NOT NULL
AND p_record_x.anc2_date <> ''
OR p_record_x.anc3_date IS NOT NULL
AND p_record_x.anc3_date <> ''
OR p_record_x.anc4_date IS NOT NULL
...
AND p_record_x.monthly_report = 'yes' 
AND ABS(
  (p_record_x.fp_method_start_date::DATE - p_record_x.fp_prev_method_switch_date::DATE) / 30
) <= 6

THEN MAT_LAFPPR_1_1 := 1;
END IF;
-- Total number of premature removal of LAFP within 6 month insertion - IUCD(MAT_LAFPPR.1. 2):Family Planning 
ELSIF p_indic_name = 'indic_MAT_LAFPPR_1_2' THEN IF p_record_x.fp_prev_method = 'iucd'
AND p_record_x.monthly_report = 'yes'
AND ABS(
  (p_record_x.fp_method_start_date::DATE - p_record_x.fp_prev_method_switch_date::DATE) / 30
) <= 6
THEN MAT_LAFPPR_1_2 := 1;
END IF;
...
AND COALESCE((p_record_x.anc1_gestational_age):: INTEGER, 0) <= 12
THEN MAT_ANC1_GA_1_1 := 1;
END IF;
...
AND COALESCE((p_record_x.gestational_age):: INTEGER, 0) <= 30
AND COALESCE((p_record_x.next_visit_num_hp):: INTEGER, 0) >= 5
THEN MAT_ANC4__GA_1_1 := 1;
END IF;
...
AND p_record_x.outcome_maternal = 'delivery'
AND p_record_x.outcome_location = 'community'
AND p_record_x.num_still_birth <> ''
THEN MAT_B_D_CDN_2_ := 1;
END IF;
...
AND COALESCE((p_record_x.pnc1_hrs_after_birth):: INTEGER, 0) <= 168
THEN MAT_EPNC_1 := 1;
END IF;
...
AND COALESCE((p_record_x.pnc1_hrs_after_birth):: INTEGER, 0) <= 24 THEN MAT_EPNC_1_1 := 1;
END IF;
...
AND COALESCE((p_record_x.pnc1_hrs_after_birth):: INTEGER, 0) > 24
AND COALESCE((p_record_x.pnc1_hrs_after_birth):: INTEGER, 0) <= 48
THEN MAT_EPNC_1_3 := 1;
END IF;
...
AND COALESCE((p_record_x.pnc1_hrs_after_birth):: INTEGER, 0) > 48
AND COALESCE((p_record_x.pnc1_hrs_after_birth):: INTEGER, 0) <= 72
THEN MAT_EPNC_1_4 := 1;
END IF;
...
ELSIF p_indic_name = 'indic_totNum_swallowed_azithromycin_or_took_tetracycline_eye_ointment' THEN IF p_record_x.tt_medication_received = 'yes' 
THEN totNum_swallowed_azithromycin_or_took_tetracycline_eye_ointment := 1;
END IF;
-- Number of who swallowed ivermectin to prevent onchocerciasis from the expected eligible population (>=5 Years)
ELSIF p_indic_name = 'indic_ivermectin' THEN IF p_record_x.oncho_medication_received = 'yes'
AND ABS(
  (p_record_x.oncho_medication_date::DATE - p_record_x.dob::DATE) / 365.25
) >= 5
THEN ivermectin := 1;
END IF;
-- Number of people who swallowed a drug to prevent lymphatic filariasis from the expected eligible population (>=5 Years)
ELSIF p_indic_name = 'indic_lymphatic_filariasis' THEN IF p_record_x.lf_medication_received = 'yes'
AND ABS(
  (p_record_x.lf_medication_date::DATE - p_record_x.dob::DATE) / 365.25
) >= 5
THEN lymphatic_filariasis := 1;
END IF;
-- Number of children who swallowed a drug to prevent schistosomiasis from the expected eligible children (5 to 15 Years)
ELSIF p_indic_name = 'indic_prevent_schistosomiasis' THEN IF p_record_x.sch_medication_received = 'yes'
AND ABS(
  (p_record_x.sch_medication_date::DATE - p_record_x.dob::DATE) / 365.25
) >= 5
AND ABS(
  (p_record_x.sch_medication_date::DATE - p_record_x.dob::DATE) / 365.25
) <= 15
THEN prevent_schistosomiasis := 1;
END IF;
...
AND ABS(
  (p_record_x.sth_medication_date::DATE - p_record_x.dob::DATE) / 365.25
) >= 5
AND ABS(
  (p_record_x.sth_medication_date::DATE - p_record_x.dob::DATE) / 365.25
) <= 19
THEN prevent_soil_transmitted_helminthiasis := 1;
END IF;
...
THEN prevent_schistosomiasis_gt := 1;
END IF;
...
AND ABS(
  p_record_x.tt_medication_date::DATE - p_record_x.dob::DATE
) < 180
THEN NTD_TR_1_1 := 1;
END IF;
...
AND ABS(
  (p_record_x.tt_medication_date::DATE - p_record_x.dob::DATE) / 365.25
) < 7
THEN NTD_TR_1_3 := 1;
END IF;
...
AND p_record_x.gender = 'male'
AND ABS(
  (p_record_x.illness_start_date::DATE - p_record_x.dob::DATE) / 365.25
) >= 18
AND ABS(
  (p_record_x.illness_start_date::DATE - p_record_x.dob::DATE) / 365.25
) <= 29
...
AND p_record_x.illnesses_to_screen = 'hypertension'
AND (
		p_record_x.danger_high_bp = 'yes'
OR p_record_x.higher_than_normal_bp = 'yes'
	)
THEN NCD_HTNDX_1_2_1 := 1;
END IF;
...
AND p_record_x.illnesses_to_screen = 'hypertension'
AND (
		p_record_x.normal_bp = 'yes'
OR p_record_x.danger_low_bp = 'yes'
	)
THEN NCD_HTNDX_1_2_2 := 1;
END IF;
...
AND p_record_x.illnesses_to_screen = 'hypertension'
AND COALESCE(p_record_x.referral_reasons, '') <> ''
THEN NCD_HTNDX_1_2_3 := 1;
END IF;
...
AND rpt_fn_get_parent_value(
  'investigated_for_malaria', 'client', 'illness', 'indices.client', p_record_x.id
) = 'yes'
AND EXTRACT(
  MONTH
FROM AGE(
      p_record_x.ftat_report_month_date:: DATE, rpt_fn_get_parent_value(
        'dob', 'client', 'illness', 'indices.client', p_record_x.id:: TEXT
      ):: DATE
    )
...
ELSIF p_indic_name = 'indic_received_finger_prick' THEN IF p_record_x.investigated_for_malaria = 'yes' 
THEN received_finger_prick := 1;
END IF;
...
AND COALESCE(p_record_x.number_people_protected_by_chemical_spray, '') <> '' 
...
AND ABS(
  (p_record_x.hew_screening_date::DATE - p_record_x.dob::DATE) / 365.25
) < 5

THEN Malaria_Cases_under_5 := 1;
END IF;
...
AND COALESCE(p_record_x.rdt_type, '') <> ''
AND rpt_fn_get_parent_value(
  'pregnant', 'client', 'illness', 'indices.client', p_record_x.id
...
AND rpt_fn_get_parent_value(
  'gender', 'client', 'illness', 'indices.client', p_record_x.id
) = 'male'
AND ABS(
  (p_record_x.hew_screening_date::DATE - p_record_x.dob::DATE) / 365.25
...
ELSIF p_indic_name = 'indic_rdt_performed_for_malaria_diagnosis' THEN IF p_record_x.screened_for_malaria = 'yes' 
THEN rdt_performed_for_malaria_diagnosis := 1;
END IF;
...
THEN malaria_positive_clients_under_1_repeat := 1;
END IF;
...
AND COALESCE(p_record_x.area_of_site_in_sq_m, '') <> '' 
THEN larva_control_in_sq_km := ROUND(p_record_x.area_of_site_in_sq_m:: NUMERIC):: INTEGER;
END IF;
...
AND COALESCE(p_record_x.area_of_site_in_sq_m, '') <> '' 
THEN compacting_activity_in_sq_km := ROUND(p_record_x.area_of_site_in_sq_m:: NUMERIC):: INTEGER;
END IF;
...
AND COALESCE(p_record_x.area_of_site_in_sq_m, '') <> '' 
THEN clearing_activity_in_sq_km := ROUND(p_record_x.area_of_site_in_sq_m:: NUMERIC):: INTEGER;
END IF;
...
AND COALESCE(p_record_x.area_of_site_in_sq_m, '') <> '' 
THEN filling_activity_in_sq_km := ROUND(p_record_x.area_of_site_in_sq_m:: NUMERIC):: INTEGER;
END IF;
...
ELSIF p_indic_name = 'indic_households_who_own_bednets' THEN IF COALESCE((p_record_x.llitn_properly_used):: INTEGER, 0) >= 1 
THEN households_who_own_bednets := 1;
END IF;
...
ELSIF p_indic_name = 'indic_peoples_involved_in_prevention' THEN IF p_record_x.case_type = 'malaria_reporting' 
THEN peoples_involved_in_prevention := 1;
END IF;
...
AND COALESCE(p_record_x.total_people_trained, '') <> '' 
THEN people_who_took_behav_change_comm_training := p_record_x.total_people_trained:: INTEGER;
END IF;
...
AND COALESCE(p_record_x.organizations_trained, '') <> '' 
THEN organizations_who_took_behav_change_comm_training := p_record_x.organizations_trained:: INTEGER;
END IF;
...
SELECT count(*) INTO individuals_living_in_index_case
FROM client c
WHERE c."indices.family" = p_record_x.id
AND c.closed = FALSE;
END IF;
...
AND p_record_x.gender = 'male'
AND ABS(
  (p_record_x.last_malaria_screening_date::DATE - p_record_x.dob::DATE) / 365.25
) < 5
THEN MAL_1 := 1;
END IF;
...
ELSIF p_indic_name = 'indic_number_of_household_members_tested' THEN IF p_record_x.illness_type = 'malaria'
AND p_record_x.screening_location = 'ftat' THEN number_of_household_members_tested := 1;
END IF;
-- Number of households investigated
ELSIF p_indic_name = 'indic_number_of_households_investigated' THEN IF p_record_x.closed = 'False' THEN number_of_households_investigated := 1;
END IF;
...
END IF;
-- refered_suspected_Schistosomiasis:Refered Schistosomiasis (SCH) Suspected on Screening:NCD
ELSIF p_indic_name = 'indic_refered_suspected_Schistosomiasis' THEN IF p_record_x.illness_type = 'ntd'
AND p_record_x.ntd_schistosomiasis = 'yes'
AND p_record_x.ever_referred_to_hc = 'yes' 
THEN refered_suspected_Schistosomiasis := 1;
END IF;
...
END IF;
-- refered_suspected_Scabies:Refered :Scabies suspected on Screening:NCD
ELSIF p_indic_name = 'indic_refered_suspected_Scabies' THEN IF p_record_x.illness_type = 'ntd'
AND p_record_x.ntd_scabies = 'yes'
AND p_record_x.ever_referred_to_hc = 'yes' 
THEN refered_suspected_Scabies := 1;
END IF;
...
ELSIF p_indic_name = 'indic_num_tt_medication' THEN IF p_record_x.closed = 'False'
...
ELSIF p_indic_name = 'indic_num_oncho_medication' THEN IF p_record_x.closed = 'False'
AND p_record_x.oncho_medication_received = 'yes'
AND ABS(
  (p_record_x.oncho_medication_date::DATE - p_record_x.dob::DATE) / 365.25
) >= 5
THEN num_oncho_medication := 1;
END IF;
...
ELSIF p_indic_name = 'indic_num_lf_medication' THEN IF p_record_x.closed = 'False'
AND p_record_x.lf_medication_received = 'yes'
AND ABS(
  (p_record_x.lf_medication_date::DATE - p_record_x.dob::DATE) / 365.25
) >= 5
THEN num_lf_medication := 1;
END IF;
...
ELSIF p_indic_name = 'indic_num_sch_medication' THEN IF p_record_x.closed = 'False'
AND p_record_x.sch_medication_received = 'yes'
AND ABS(
  (p_record_x.sch_medication_date::DATE - p_record_x.dob::DATE) / 365.25
) >= 5
AND ABS(
...
ELSIF p_indic_name = 'indic_num_sth_medication_child' THEN IF p_record_x.closed = 'False'
...
THEN num_sth_medication_child := 1;
END IF;
...
ELSIF p_indic_name = 'indic_num_sth_medication_adult' THEN IF p_record_x.closed = 'False'
AND p_record_x.sth_medication_received = 'yes'
AND ABS(
  (p_record_x.sth_medication_date::DATE - p_record_x.dob::DATE) / 365.25
) >= 20
...
THEN num_sth_medication_adult := 1;
END IF;
...
ELSIF p_indic_name = 'indic_MS_OPD_NumOV_1_4' THEN IF p_record_x.gender = 'female'
AND
       (
    DATE_PART('year', AGE(p_record_x.visit_date::DATE, p_record_x.dob::DATE))  
  ) BETWEEN 5 AND 9
...
ELSIF p_indic_name = 'indic_MS_OPD_NumOV_1_5' THEN IF p_record_x.gender = 'male'
AND
       (
    DATE_PART('year', AGE(p_record_x.visit_date::DATE, p_record_x.dob::DATE))  
  ) BETWEEN 11 AND 19
...
ELSIF p_indic_name = 'indic_MS_OPD_NumOV_1_6' THEN IF p_record_x.gender = 'female'
AND
       (
    DATE_PART('year', AGE(p_record_x.visit_date::DATE, p_record_x.dob::DATE))  
...
ELSIF p_indic_name = 'indic_MS_OPD_NumOV_1_7' THEN IF p_record_x.gender = 'male'
AND
       (
    DATE_PART('year', AGE(p_record_x.visit_date::DATE, p_record_x.dob::DATE))  
...
ELSIF p_indic_name = 'indic_MS_OPD_NumOV_1_8' THEN IF p_record_x.gender = 'female'
AND
       (
    DATE_PART('year', AGE(p_record_x.visit_date::DATE, p_record_x.dob::DATE))  
...
ELSIF p_indic_name = 'indic_MS_OPD_NumOV_1_9' THEN IF p_record_x.gender = 'male'
AND
       (
    DATE_PART('year', AGE(p_record_x.visit_date::DATE, p_record_x.dob::DATE))  
...
ELSIF p_indic_name = 'indic_MS_OPD_NumOV_1_10' THEN IF p_record_x.gender = 'female'
AND
       (
    DATE_PART('year', AGE(p_record_x.visit_date::DATE, p_record_x.dob::DATE))  
...
ELSIF p_indic_name = 'indic_MS_OPD_NumOV_1_11' THEN IF p_record_x.gender = 'male'
AND
       (
    DATE_PART('year', AGE(p_record_x.visit_date::DATE, p_record_x.dob::DATE))  
...
ELSIF p_indic_name = 'indic_MS_OPD_NumOV_1_12' THEN IF p_record_x.gender = 'female'
AND
       (
    DATE_PART('year', AGE(p_record_x.visit_date::DATE, p_record_x.dob::DATE))  
...
ELSIF p_indic_name = 'indic_CHIM_ECND_2_1' THEN IF (
  p_record_x.closed = 'True'
	AND EXTRACT(
    DAY
FROM AGE(p_record_x.death_date:: DATE, p_record_x.dob:: DATE)
  ) <= 7
...
OR (
  p_record_x.closed = 'True'
    ...
    EXTRACT(
      DAY
FROM AGE(p_record_x.dob:: DATE, p_record_x.dob:: DATE)
    ) >= 1
		AND EXTRACT(
      DAY
	FROM AGE(p_record_x.dob:: DATE, p_record_x.dob:: DATE)
...
ELSIF p_indic_name = 'indic_NTR_GMP_MM_1' THEN IF
 p_record_x.gmp_newest_weight_status = 'moderately_underweight'
AND
     (
...
ELSIF p_indic_name = 'indic_GMP_SM_1' THEN IF
 p_record_x.gmp_newest_weight_status = 'severely_underweight'
AND
     (
    DATE_PART('year', AGE(p_record_x.gmp_newest_weight_status_date::DATE, p_record_x.dob::DATE)) * 12
    + DATE_PART('month', AGE(p_record_x.gmp_newest_weight_status_date::DATE, p_record_x.dob::DATE))
...
ELSIF p_indic_name = 'indic_NUT_DeW_1_2' THEN IF
  COALESCE(p_record_x.deworming_second_dose_date, '') <> ''
...
AND (p_record_x.give_deworming = 'yes'
	OR p_record_x.deworming_received = 'yes')
AND (COALESCE(p_record_x.outcome_maternal, '') <> ''
	OR p_record_x.post_partum = 'no')
...
AND (p_record_x.start_nutrition_status = 'mam'
	OR p_record_x.start_nutrition_status = 'normal')
...
ELSIF p_indic_name = 'indic_NUT_U5SMN_1_1' THEN IF
 ...
 (p_record_x.start_nutrition_status = 'red'
	OR p_record_x.start_nutrition_status = 'yellow'
	OR p_record_x.start_nutrition_status = 'green')
AND (
...
AND( p_record_x.treatment_location = 'health_center'
	OR p_record_x.treatment_location = 'hospital' )
AND(
...
AND ( p_record_x.treatment_location = 'health_center'
	OR p_record_x.treatment_location = 'hospital' )
AND ( p_record_x.admission_category = 'new_case'
	OR p_record_x.admission_category = 'relapse' )
AND (
...
ELSIF p_indic_name = 'indic_NUT_TX_U5MN_SAM_TO_SC_6_2' THEN IF
 p_record_x.closed = TRUE
AND p_record_x.newest_sc_treatment_outcome = 'transferred_out' and
...
ELSIF p_indic_name = 'indic_NUT_TX_U5MN_SAM_Def_SC_7_1' THEN IF
 p_record_x.closed = TRUE
AND p_record_x.newest_sc_treatment_outcome = 'client_defaulted' and
...
AND p_record_x.treatment_plan = 'OTP Follow-up' and
...
AND p_record_x.start_nutrition_status = 'red'
AND (
    DATE_PART('year', AGE(p_record_x.discharged_date::DATE, p_record_x.dob::DATE)) * 12
    + DATE_PART('month', AGE(p_record_x.discharged_date::DATE, p_record_x.dob::DATE))
  ) BETWEEN 6 AND 60
...
AND p_record_x.start_nutrition_status = 'mam'
AND p_record_x.child_or_plw = 'plw'
AND (p_record_x.tsfp_followup = 'yes'
	OR p_record_x.imam_followup = 'yes') 
...
-----------**************** QUARTERLY REPORTS ***************-----------
-- HSEH_ES_ALTR:Proportion of households with access to any type of latrine facilities
ELSIF p_indic_name = 'indic_HSEH_ES_ALTR' THEN IF p_record_x.latrine_available = 'yes'
AND ABS(
  (p_record_x.household_visit_date::DATE - CURRENT_DATE::DATE) / 30
) <= 3
THEN HSEH_ES_ALTR := 1;
END IF;
-- COS_HEP_CMHH: Proportion of Model households graduated / Households Currently Model/
ELSIF p_indic_name = 'indic_COS_HEP_CMHH' THEN IF p_record_x.graduation = 'yes'
AND ABS(
  (p_record_x.graduation_date::DATE - CURRENT_DATE::DATE) / 30
) <= 3
THEN COS_HEP_CMHH := 1;
END IF;
-- COS_MHH.New.1: Number of Newly graduated model households during the reporting period
ELSIF p_indic_name = 'indic_COS_MHH_New_1' THEN IF p_record_x.graduation = 'yes'
AND p_record_x.prev_graduate <> 'yes'
AND ABS(
  (p_record_x.graduation_date::DATE - CURRENT_DATE::DATE) / 30
) <= 3
THEN COS_MHH_New_1 := 1;
END IF;
-- HEH_HHHWF: Number of Households having hand washing facilities at the premise - Number of Households having hand washing facilities at the premise(HEH_HHHWF):HP Quarterly Services
ELSIF p_indic_name = 'indic_HEH_HHHWF' THEN IF p_record_x.hand_washing_facility_available = 'yes'
AND ABS(
  (p_record_x.date_having_hand_washing::DATE - CURRENT_DATE::DATE) / 30
) <= 3
THEN HEH_HHHWF := 1;
END IF;
-- HEH_HHHH_: Households with healthy housing - Number of HHs with separate animal house(HEH_HHHH.):HP Quarterly Services
ELSIF p_indic_name = 'indic_HEH_HHHH_' THEN IF p_record_x.separate_animal_house = 'yes'
AND ABS(
  (p_record_x.household_properties_visit_date::DATE - CURRENT_DATE::DATE) / 30
) <= 3
THEN HEH_HHHH_ := 1;
END IF;
-- HEH_HHHH_2_: Households with healthy housing - Number of HHs with separate Kitchen(HEH_HHHH.2.):HP Quarterly Services
ELSIF p_indic_name = 'indic_HEH_HHHH_' THEN IF p_record_x.separate_kitchen = 'yes'
AND ABS(
  (p_record_x.household_properties_visit_date::DATE - CURRENT_DATE::DATE) / 30
) <= 3
THEN HEH_HHHH_2_ := 1;
END IF;
-- HEH_HHHH_3_: Households with healthy housing - Number of HHs with smokeless stove(HEH_HHHH.3.):HP Quarterly Services
ELSIF p_indic_name = 'indic_HEH_HHHH_' THEN IF p_record_x.smokeless_stove = 'yes'
AND ABS(
  (p_record_x.household_properties_visit_date::DATE - CURRENT_DATE::DATE) / 30
) <= 3
THEN HEH_HHHH_3_ := 1;
END IF;
-- HEPHC_MODEL_H_1_1_: Number of currently model households in the catchment - Number of New model households during the reporting period(HEPHC_MODEL_H.1.1.):HP Quarterly Services
ELSIF p_indic_name = 'indic_CHEPHC_MODEL_H_1_1_' THEN IF p_record_x.graduation = 'yes'
AND p_record_x.prev_graduate <> 'yes'
AND ABS(
  (p_record_x.graduation_date::DATE - CURRENT_DATE::DATE) / 30
) <= 3
THEN HEPHC_MODEL_H_1_1_ := 1;
END IF;
-- HEPHC_MODEL_H_1_2_: Number of currently model households in the catchment - Number of previously model HHS(HEPHC_MODEL_H.1.2.):HP Quarterly Services
ELSIF p_indic_name = 'indic_HEPHC_MODEL_H_1_2_' THEN IF p_record_x.prev_graduate = 'yes'
AND ABS(
  (p_record_x.implementation_visit_date::DATE - CURRENT_DATE::DATE) / 30
) <= 3
THEN HEPHC_MODEL_H_1_2_ := 1;
END IF;
-- HEPHC_MODEL_H_1_3_: Number of currently model households in the catchment - Number of HHs who drop out from being model HHs(HEPHC_MODEL_H.1.3.):HP Quarterly Services
ELSIF p_indic_name = 'indic_HEPHC_MODEL_H_1_3_' THEN IF p_record_x.graduation = 'no'
AND p_record_x.prev_graduate = 'no'
AND p_record_x.graduation_date = ''
AND ABS(
  (p_record_x.implementation_visit_date::DATE - CURRENT_DATE::DATE) / 30
) <= 3
THEN HEPHC_MODEL_H_1_3_ := 1;
END IF;
-- HEPHC_H_: Number of currently model households in the catchment - Total number of households(HEPHC_H.):HP Quarterly Services
ELSIF p_indic_name = 'indic_HEPHC_H_' THEN IF p_record_x.case_type = 'family'
AND ABS(
  (p_record_x.graduation_date::DATE - CURRENT_DATE::DATE) / 30
) <= 3
THEN HEPHC_H_ := 1;
...
WHEN OTHERS THEN
-- Comment out or remove the error logging if not required
RAISE WARNING 'Compute error: %', SQLERRM;
