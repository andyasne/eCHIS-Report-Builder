...
IF p_indic_name = 'indic_pregnant_women_received_ANC_First_visit_by_gestational_week' THEN
    ...
    IF p_record_x.anc1_date IS NOT NULL AND p_record_x.anc1_date <> ''
     AND p_record_x.anc1_gestational_age = '0'
...
ELSIF p_indic_name = 'indic_Number_of_slides_or_RDT_positive_for_malaria' THEN
    IF 
     p_record_x.hew_rdt_result = 'positive'
...
ELSIF p_indic_name = 'indic_Number_of_women_who_have_received_TT1_vaccination' THEN
    ...
    IF p_record_x.tt1_date IS NOT NULL AND p_record_x.tt1_date <> ''
     AND p_record_x.case_type = 'client'
...
ELSIF p_indic_name = 'indic_Number_of_women_who_have_received_TT2_vaccination' THEN
    ...
    IF p_record_x.tt2_date IS NOT NULL AND p_record_x.tt2_date <> ''
     AND p_record_x.case_type = 'client'
...
ELSIF p_indic_name = 'indic_Number_of_women_who_have_received_TT3_vaccination' THEN
    ...
    IF p_record_x.tt3_date IS NOT NULL AND p_record_x.tt3_date <> ''
     AND p_record_x.case_type = 'client'
...
ELSIF p_indic_name = 'indic_Number_of_women_who_have_received_TT4_vaccination' THEN
    ...
    IF p_record_x.tt4_date IS NOT NULL AND p_record_x.tt4_date <> ''
     AND p_record_x.case_type = 'client'
...
ELSIF p_indic_name = 'indic_Number_of_women_who_have_received_TT5_vaccination' THEN
    ...
    IF p_record_x.tt5_date IS NOT NULL AND p_record_x.tt5_date <> ''
     AND p_record_x.case_type = 'client'
...
ELSIF p_indic_name = 'indic_fp_new_at_10_to_14' THEN
    IF 
     ...
     AND p_record_x.age_range = '10-14'
...
ELSIF p_indic_name = 'indic_fp_new_at_15_to_19' THEN
    IF 
     p_record_x.yearly_report = 'yes'
     AND p_record_x.fp_acceptor_type = 'new'
     AND p_record_x.age_range = '15-19'
...
ELSIF p_indic_name = 'indic_fp_new_at_20_to_24' THEN
    IF 
     p_record_x.yearly_report = 'yes'
     AND p_record_x.fp_acceptor_type = 'new'
     AND p_record_x.age_range = '20-24'
...
ELSIF p_indic_name = 'indic_fp_new_at_25_to_29' THEN
    IF 
     p_record_x.yearly_report = 'yes'
     AND p_record_x.fp_acceptor_type = 'new'
     AND p_record_x.age_range = '25-29'
...
ELSIF p_indic_name = 'indic_fp_new_at_30_to_49' THEN
    IF 
     p_record_x.yearly_report = 'yes'
     AND p_record_x.fp_acceptor_type = 'new'
     AND p_record_x.age_range = '30-49'
...
ELSIF p_indic_name = 'indic_fp_new_injectables' THEN
    IF 
     p_record_x.yearly_report = 'yes'
     AND p_record_x.fp_acceptor_type = 'new'
     AND p_record_x.fp_method = 'injections'
...
ELSIF p_indic_name = 'indic_fp_new_implants' THEN
    IF 
     p_record_x.yearly_report = 'yes'
     AND p_record_x.fp_acceptor_type = 'new'
     AND p_record_x.fp_method = 'implants'
...
ELSIF p_indic_name = 'indic_postnatal_0_24' THEN
    IF 
     p_record_x.pnc1_hrs_after_birth = '24'
     AND p_record_x.pnc1_hrs_after_birth = '0'
...
ELSIF p_indic_name = 'indic_postnatal_25_48' THEN
    IF 
     p_record_x.pnc1_hrs_after_birth = '48'
     AND p_record_x.pnc1_hrs_after_birth = '25'
...
ELSIF p_indic_name = 'indic_postnatal_49_72' THEN
    IF 
     p_record_x.pnc1_hrs_after_birth = '72'
     AND p_record_x.pnc1_hrs_after_birth = '49'
...
ELSIF p_indic_name = 'indic_postnatal_73_168' THEN
    IF 
     p_record_x.pnc1_hrs_after_birth = '168'
     AND p_record_x.pnc1_hrs_after_birth = '73'
...
ELSIF p_indic_name = 'indic_deaths_of_home' THEN
    IF 
     ...
     AND p_record_x.death_maternal = 'yes'
...
ELSIF p_indic_name = 'indic_penta1' THEN
    IF 
     p_record_x.epi_location = 'health_post'
...
ELSIF p_indic_name = 'indic_infants_whose_mother' THEN
    IF 
     p_record_x.preventative_tt = 'yes'
...
ELSIF p_indic_name = 'indic_FP_CAR_Mtd_2_7' THEN
    IF 
     p_record_x.fp_acceptor_type = 'repeat'
...
ELSIF p_indic_name = 'indic_L_D_SBA_1' THEN
    ...
    IF p_record_x.outcome_date IS NOT NULL AND p_record_x.outcome_date <> ''
     AND p_record_x.outcome_location = 'health_post'
...
ELSIF p_indic_name = 'indic_MAT_LAFPPR_1_1' THEN
    IF 
     p_record_x.fp_prev_method = 'implants'
     AND p_record_x.monthly_report = 'yes'
...
ELSIF p_indic_name = 'indic_MAT_LAFPPR_1_2' THEN
    IF 
     p_record_x.fp_prev_method = 'iusd'
     AND p_record_x.monthly_report = 'yes'
...
ELSIF p_indic_name = 'indic_MAT_LAFPPR_1_3' THEN
    IF 
     p_record_x.fp_prev_method = 'other'
     AND p_record_x.monthly_report = 'yes'
...
ELSIF p_indic_name = 'indic_MAT_TLAFPR_' THEN
    ...
    IF p_record_x.fp_prev_method_switch_date IS NOT NULL AND p_record_x.fp_prev_method_switch_date <> ''
     AND p_record_x.monthly_report = 'yes'
...
ELSIF p_indic_name = 'indic_MAT_ANC1_GA_1_1' THEN
    IF 
     ...
     AND p_record_x.anc1_gestational_age = '12'
...
ELSIF p_indic_name = 'indic_MAT_ANC4__GA_1_1' THEN
    ...
    IF p_record_x.anc4_date IS NOT NULL AND p_record_x.anc4_date <> ''
...
ELSIF p_indic_name = 'indic_MAT_EPNC_1' THEN
    IF 
     p_record_x.closed = 'False'
     AND p_record_x.pnc1_hrs_after_birth = '168'
...
ELSIF p_indic_name = 'indic_EPI_FI_1_' THEN
    IF 
     p_record_x.full_immunization_under_1 = 'yes'
     AND p_record_x.closed = 'False'
...
ELSIF p_indic_name = 'indic_EPI_VWR_BCG_dam_' THEN
    IF 
     p_record_x.loss_adjustment_reason = 'item_broken'
...
ELSIF p_indic_name = 'indic_EPI_VWR_BCG_dis_' THEN
    IF 
     p_record_x.loss_adjustment_reason = 'item_expired'
     AND p_record_x.medication_name = 'BCG''`(Bacillus`Calmette`Guerin)`Vaccine`Injection`with`Diluent'
...
ELSIF p_indic_name = 'indic_EPI_VWR_MCV_dam_' THEN
    IF 
     p_record_x.loss_adjustment_reason = 'item_broken'
     AND p_record_x.medication_name = 'Measles`Virus`Vaccine`Injection`(Live`Attenuated`and`Freeze`Dried)`with`Diluent)'
...
ELSIF p_indic_name = 'indic_EPI_VWR_IPV_dam_' THEN
    IF 
     p_record_x.loss_adjustment_reason = 'item_broken'
     AND p_record_x.medication_name = 'IPV`(Inactivated`Polio`Vaccine)'
...
ELSIF p_indic_name = 'indic_totNum_swallowed_azithromycin_or_took_tetracycline_eye_ointment' THEN
    IF 
     p_record_x.tt_medication_received = 'yes'
...
ELSIF p_indic_name = 'indic_ivermectin' THEN
    IF 
     p_record_x.oncho_medication_received = 'yes'
...
ELSIF p_indic_name = 'indic_lymphatic_filariasis' THEN
    IF 
     p_record_x.lf_medication_received = 'yes'
...
ELSIF p_indic_name = 'indic_prevent_schistosomiasis' THEN
    IF 
     p_record_x.sch_medication_received = 'yes'
...
ELSIF p_indic_name = 'indic_prevent_soil_transmitted_helminthiasis' THEN
    IF 
     p_record_x.sth_medication_received = 'yes'
...
ELSIF p_indic_name = 'indic_confirmed_malaria_cases_ftat' THEN
    IF 
     p_record_x.illness_type = 'malaria'
     AND p_record_x.visit_type = 'FTAT'
...
ELSIF p_indic_name = 'indic_households_investigated' THEN
    IF 
    p_record_x.ftat_status = 'Case investigation completed'
     OR p_record_x.ftat_status = 'In progress'
...
ELSIF p_indic_name = 'indic_received_finger_prick' THEN
    IF 
     p_record_x.investigated_for_malaria = 'yes'
...
ELSIF p_indic_name = 'indic_Cases_without_travel_history' THEN
    IF 
     p_record_x.illness_type = 'malaria'
     AND p_record_x.investigated_for_malaria = 'yes'
     AND p_record_x.travel_history = 'no'
...
ELSIF p_indic_name = 'indic_number_people_protected_by_chemical_spray' THEN
    ...
    THEN   
     number_people_protected_by_chemical_spray := p_record_x.number_people_protected_by_chemical_spray::INTEGER;
    END IF;
...
ELSIF p_indic_name = 'indic_chemical_used_in_kg' THEN
    IF 
     p_record_x.chemical_spray = 'yes'
 	 AND COALESCE(p_record_x.chemical_used_in_kg, '') <> ''
    
    THEN   
        chemical_used_in_kg := p_record_x.chemical_used_in_kg::INTEGER;
    END IF;
   
-- Number of visited households on bednet usage
ELSIF p_indic_name = 'indic_bednet_usage' THEN
    IF 
     COALESCE(p_record_x.llitn_properly_used, '') <> ''
    THEN   
        bednet_usage := 1;
    END IF;
...
ELSIF p_indic_name = 'indic_llitn_properly_used' THEN
    IF 
     COALESCE(p_record_x.llitn_properly_used, '') = 'yes'
...
ELSIF p_indic_name = 'indic_suspected_and_tested_with_rdt' THEN
    IF 
	 ...
	 and (p_record_x.screening_location  = 'health_post'
...
ELSIF p_indic_name = 'indic_RDT_Confirmed_Malaria_Cases_pf' THEN
    IF 
	 ...
	 and (p_record_x.screening_location  = 'health_post'
     or p_record_x.screening_location  = 'community')
	  AND COALESCE(p_record_x.rdt_type, '') = 'pf'
...
ELSIF p_indic_name = 'indic_RDT_Confirmed_Malaria_Cases_pv' THEN
    IF 
	 ...
	 and (p_record_x.screening_location  = 'health_post'
     or p_record_x.screening_location  = 'community')
	  AND COALESCE(p_record_x.rdt_type, '') = 'pv'
...
ELSIF p_indic_name = 'indic_RDT_positive_for_malaria' THEN
    IF 
     p_record_x.illness_type = 'malaria'AND (p_record_x.screening_location  = 'health_post'
     OR p_record_x.screening_location  = 'community')
...
ELSIF p_indic_name = 'indic_RDT_positive_for_malaria_male_over_15' THEN
    IF 
     p_record_x.illness_type = 'malaria'   AND 
...
ELSIF p_indic_name = 'indic_rdt_performed_for_malaria_diagnosis' THEN
    IF 
     p_record_x.screened_for_malaria = 'yes'
...
ELSIF p_indic_name = 'indic_malaria_suspect_but_not_tested' THEN
    IF 
     p_record_x.illness_type = 'malaria'
     AND p_record_x.suspected = 'yes'
     AND p_record_x.tested = 'no'    AND (p_record_x.screening_location  = 'health_post'
     OR p_record_x.screening_location  = 'community') 
...
ELSIF p_indic_name = 'indic_breeding_site' THEN
    IF 
     p_record_x.case_type = 'breeding_site'
...
ELSIF p_indic_name = 'indic_breeding_site_permanent' THEN
    IF 
     p_record_x.type_of_site= 'permanent'
...
ELSIF p_indic_name = 'indic_breeding_site_temporary' THEN
    IF 
     p_record_x.type_of_site= 'temporary'
...
ELSIF p_indic_name = 'indic_larva_control' THEN
    ...
    IF p_record_x.draining_date IS NOT NULL 
...
ELSIF p_indic_name = 'indic_larva_control_in_sq_km' THEN
    ...
    THEN   
     larva_control_in_sq_km :=ROUND(p_record_x.area_of_site_in_sq_m::NUMERIC)::INTEGER;
...
ELSIF p_indic_name = 'indic_compacting_activity' THEN
    ...
    IF p_record_x.compacting_date IS NOT NULL
...
ELSIF p_indic_name = 'indic_compacting_activity_in_sq_km' THEN
    ...
    THEN   
    	compacting_activity_in_sq_km :=ROUND(p_record_x.area_of_site_in_sq_m::NUMERIC)::INTEGER;
...
ELSIF p_indic_name = 'indic_clearing_activity' THEN
    ...
    IF p_record_x.clearing_date IS NOT NULL   AND COALESCE(p_record_x.clearing_date, '') <> ''
...
ELSIF p_indic_name = 'indic_clearing_activity_in_sq_km' THEN
    ...
    IF p_record_x.clearing_date IS NOT NULL 
         AND COALESCE(p_record_x.clearing_date, '') <> ''

     AND COALESCE(p_record_x.area_of_site_in_sq_m, '') <> ''
    
    THEN   
    	clearing_activity_in_sq_km :=ROUND(p_record_x.area_of_site_in_sq_m::NUMERIC)::INTEGER;
...
ELSIF p_indic_name = 'indic_filling_activity' THEN
    ...
    IF p_record_x.filling_date IS NOT NULL  
...
ELSIF p_indic_name = 'indic_filling_activity_in_sq_km' THEN
    ...
    THEN   
    	filling_activity_in_sq_km :=ROUND(p_record_x.area_of_site_in_sq_m::NUMERIC)::INTEGER;
...
ELSIF p_indic_name = 'indic_households_who_own_bednets' THEN
    IF 
     ...
     COALESCE((p_record_x.llitn_properly_used)::INTEGER, 0) >= 1
...
ELSIF p_indic_name = 'indic_households_who_own_but_not_use' THEN
    IF 
     COALESCE((p_record_x.llitn_properly_used)::INTEGER, 0) = 0
     AND COALESCE((p_record_x.llitn_distributed)::INTEGER, 0) >= 1
...
ELSIF p_indic_name = 'indic_peoples_involved_in_prevention' THEN
    IF 
     p_record_x.case_type = 'malaria_reporting'
...
ELSIF p_indic_name = 'indic_people_who_took_behav_change_comm_training' THEN
    IF 
        p_record_x.type_of_training LIKE '%malaria_behavioural_change_communication%'
        AND COALESCE(p_record_x.total_people_trained, '') <> ''
    THEN   
        people_who_took_behav_change_comm_training := p_record_x.total_people_trained::INTEGER;
    END IF;
...
ELSIF p_indic_name = 'indic_male_who_took_behav_change_comm_training' THEN
    IF 
        p_record_x.type_of_training LIKE '%malaria_behavioural_change_communication%'
        AND COALESCE(p_record_x.male_trained, '') <> ''
     THEN   
        male_who_took_behav_change_comm_training :=  p_record_x.male_trained::INTEGER  ;  
    END IF;
...
ELSIF p_indic_name = 'indic_female_who_took_behav_change_comm_training' THEN
    IF 
      p_record_x.type_of_training LIKE '%malaria_behavioural_change_communication%'
        AND COALESCE(p_record_x.female_trained, '') <> ''
     THEN   
        female_who_took_behav_change_comm_training :=  p_record_x.female_trained::INTEGER   ;     
    END IF;
...
ELSIF p_indic_name = 'indic_organizations_who_took_behav_change_comm_training' THEN
    IF 
     ...
     THEN   
        organizations_who_took_behav_change_comm_training :=  p_record_x.organizations_trained::INTEGER  ;         
    END IF;
...
ELSIF p_indic_name = 'indic_individuals_living_in_index_case' THEN
    IF 
     COALESCE((p_record_x.distance_from_index , '')::INTEGER, 0) >= 0
          AND  COALESCE((p_record_x.distance_from_index , '')::INTEGER, 0) <= 70
 
    THEN   
         select count(*) into individuals_living_in_index_case from client c where c."indices.family" = p_record_x.id and c.closed = false;       
     END IF;
...
ELSIF p_indic_name = 'indic_Mal_Travel_' THEN
    IF 
     ...
     AND p_record_x.travel_history = 'yes'
     AND p_record_x.rdt_type = 'positive'
     AND (p_record_x.gender = 'female' or p_record_x.gender = 'male')
...
ELSIF p_indic_name = 'indic_hh_members_eligible_butnot_indexcases' THEN
    IF 
     ...
     AND p_record_x.illness_type = 'malaria'
     AND p_record_x.screening_location = 'ftat'
     AND p_record_x.severe_illness = 'no'
...
ELSIF p_indic_name = 'indic_indigenous_or_local_cases_cases_without_travel_history' THEN
    IF 
     ...
     AND p_record_x.illness_type = 'malaria'
     AND p_record_x.screening_location = 'ftat'
     AND p_record_x.malarious_area = 'yes'
...
ELSIF p_indic_name = 'indic_num_tt_medication' THEN
    IF 
     p_record_x.case_type = 'client'
     AND p_record_x.closed = 'False'
     AND p_record_x.tt_medication_received = 'yes'
...
ELSIF p_indic_name = 'indic_TB_CR_PTB_1_1_2' THEN
    IF 
     ...
     AND p_record_x.hc_tb_screening_pulmonary_type = 'pulmonary'
     AND p_record_x.pulmonary_type_identified_by = 'bacteriologically'
     AND p_record_x.illness_status = 'cured'
...
ELSIF p_indic_name = 'indic_TB_CR_PTB_1_1_3' THEN
    IF 
     ...
     AND p_record_x.hc_tb_screening_pulmonary_type = 'pulmonary'
     AND p_record_x.pulmonary_type_identified_by = 'bacteriologically'
     AND p_record_x.client_follow_up_status_at_hc = 'lost_to_follow_up'
...
ELSIF p_indic_name = 'indic_TB_CR_PTB_1_1_4' THEN
    IF 
     ...
     AND p_record_x.hc_tb_screening_pulmonary_type = 'pulmonary'
     AND p_record_x.pulmonary_type_identified_by = 'bacteriologically'
     AND p_record_x.illness_status = 'client_died'
...
ELSIF p_indic_name = 'indic_TB_CR_PTB_1_1_5' THEN
    IF 
     ...
     AND p_record_x.hc_tb_screening_pulmonary_type = 'pulmonary'
     AND p_record_x.pulmonary_type_identified_by = 'bacteriologically'
     AND p_record_x.illness_status = 'treatment_failed'
...
ELSIF p_indic_name = 'indic_TB_CR_EPTB_3_1_1' THEN
    IF 
     ...
     AND p_record_x.illness_status = 'treatment_completed'
...
ELSIF p_indic_name = 'indic_TB_TPT_1_4_1' THEN
    IF 
     ...
     AND p_record_x.contact_screening_visit = 'yes'
     AND p_record_x.hc_screening_classification = 'latent_tb_infection'
     AND p_record_x.tpt_med_names = '3HP'
...
ELSIF p_indic_name = 'indic_TB_TPT_1_4_2' THEN
    IF 
     ...
     AND p_record_x.contact_screening_visit = 'yes'
     AND p_record_x.hc_screening_classification = 'latent_tb_infection'
     AND p_record_x.tpt_med_names = '3RH'
...
ELSIF p_indic_name = 'indic_TB_TPT_1_4_3' THEN
    IF 
     ...
     AND p_record_x.contact_screening_visit = 'yes'
     AND p_record_x.hc_screening_classification = 'latent_tb_infection'
     AND p_record_x.tpt_med_names = '6H'
...
ELSIF p_indic_name = 'indic_Grade_II_disability_rate_among_new_cases_of_leprosy_Female_gt_15' THEN
    ...
    THEN   
        Grade_II_disability_rate_among_new_cases_of_leprosy_Fem_gt_15 := 1;
    END IF;
...
ELSIF p_indic_name = 'indic_Grade_II_disability_rate_among_new_cases_of_leprosy_Female_gte_15' THEN
    ...
    THEN   
        Grade_II_disability_rate_among_new_cases_of_leprosy_Fem_gte_15 := 1;
    END IF;
...
ELSIF p_indic_name = 'indic_LEP_NOT__1_1_1' THEN
    IF 
     ...
     AND p_record_x.hc_leprosy_type = 'pb_leprosy'
...
ELSIF p_indic_name = 'indic_LEP_NOT__1_1_5_1' THEN
    IF 
     ...
     AND p_record_x.illness_type = 'leprosy'
     AND p_record_x.hew_screening_classification = 'Leprosy Presumed'
     AND p_record_x.hc_leprosy_type = 'mb_leprosy'
...
ELSIF p_indic_name = 'indic_LEP_DIS_1_1' THEN
    IF 
     ...
     AND p_record_x.illness_type = 'leprosy'
     AND p_record_x.hew_screening_classification = 'Leprosy Presumed'
     AND p_record_x.level_of_leprosy_grade = 'disability_grade_2'
...
ELSIF p_indic_name = 'indic_xsum' THEN
    IF 
     p_record_x.property_name = 'xproperty_name'
...
ELSIF p_indic_name = 'indic_PMS_AVAIL_1_28_' THEN
    IF 
     p_record_x.medication_name = 'Zinc''Acetate''20mg''Tablet''(Scored''&''Dispersable)'
     AND p_record_x.balance = '0'
...
ELSIF p_indic_name = 'indic_PMS_AVAIL_1_29_' THEN
    IF 
     p_record_x.medication_name = 'Gentamicin''40mg/ml''in''2ml''Ampoule''Injection'
     AND p_record_x.balance = '0'
...
ELSIF p_indic_name = 'indic_PMS_AVAIL_1_30_' THEN
    IF 
     p_record_x.medication_name = 'Medroxyprogesterone''Acetate''150mg/ml''in''1ml''vial''Injection''(Aqueous''suspension)(depoprovera)'
     AND p_record_x.balance = '0'
...
ELSIF p_indic_name = 'indic_PMS_AVAIL_1_32_' THEN
    IF 
     p_record_x.medication_name = 'Ferrous''Sulphate''+''Folic''Acid''(200mg''+''0.4mg)''Tablet'
     AND p_record_x.balance = '0'
...
ELSIF p_indic_name = 'indic_PMS_AVAIL_1_33_' THEN
    IF 
     p_record_x.medication_name = 'Albendazole''400mg''Tablet'
     AND p_record_x.balance = '0'
